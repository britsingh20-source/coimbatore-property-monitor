...
try:
    ...
    if proc.returncode != 0:
        raise RuntimeError("Offline LTX inference failed: " + (proc.stderr or proc.stdout)[-5000:])
...
def write_kernel(folder: Path, username: str, source_image: Path, ltx_bundle: Path, prompt: str, video_id: str) -> str:
