...
Hard cut to the verified gate, covered parking or portico with a controlled forward move. Preserve its visible tiles, pillars, gate and dimensions. Keep the entrance clean and free of ceremonial markings. Do not morph through the door."""
        ...
        shot_plan = f"""Create seven clearly different, architecturally consistent shots of approximately 1.4 seconds each. Use clean hard cuts only. All seven shots must show the same property with identical elevation, tiles, wall colours, ceiling design, doors, windows, fixtures and room proportions.
