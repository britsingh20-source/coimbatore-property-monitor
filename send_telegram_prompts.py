...
def send_prompt(job: dict, bot_token: str, chat_id: str) -> int:
    ...
    caption = (
        ...
        "FULL PROMPT: open the attached .txt file, Select All → Copy, then paste in Gemini. "
        "Telegram does not allow a copy_text button for a prompt this long. Allow Gemini to open "
