...
def build_reference_prompt(candidate: dict, analysis: dict, config: dict) -> str:
    ...
    for i in range(7):
        shots.append(f"SHOT {i+1} — {times[i]} SECONDS — {labels[i]}\nHard cut to {instructions[i]}. Use an invisible first-person stabilized viewpoint with a controlled push-in, lateral slide or detail reveal appropriate to the source. The recording device and operator always remain completely outside the frame. Preserve the same room, product geometry, materials, colours, scale and installation. If this subject is not visible in the reference, substitute a different visually verified detail; never invent it.")
...
Generate one completely new, highly photorealistic, exactly 10-second vertical 9:16 interior source clip at 60 fps. It will be slowed to 33.3% speed in VN Editor to create a smooth 30-second final video. Do not reuse source frames directly. Reconstruct only the visually confirmed design identity. It must resemble genuine stabilized first-person interior walkthrough footage inside a real occupied Indian home or working interior showroom—not an architectural render, showroom CGI, slideshow, AI-image animation or behind-the-scenes recording.

INVISIBLE-CAMERA LOCK
Every shot is the clean point of view of an invisible camera. Never show a cameraman, camera operator, photographer, videographer, person holding equipment, hand, arm, body, camera, phone, gimbal, stabilizer, tripod, light stand, microphone, monitor, cable, filming crew, making-of setup, or behind-the-scenes activity. Do not show any camera/operator reflection in glass, mirrors, televisions, polished cabinets or metal. Do not show their shadow on walls, floors, furniture or ceilings. The camera is only the unseen viewpoint; filming equipment must never become a subject or visible object.
...
FIXED REALISM RULES
Exactly 10 seconds; native 60 fps; vertical 9:16; designed for smooth 3× slow motion; seven distinct shots; photorealistic first-person walkthrough footage; invisible recording device; preserve the verified reference identity; hard cuts; no invented rooms or mechanisms; no presenter, copied person, cameraman or filming crew; no visible camera, gimbal, hand, reflection or crew shadow; no competitor logos or text; no religious imagery; no impossible cabinet movement; no floating camera; no morphing geometry; no glossy CGI surfaces; no excessive cinematic haze; no perfect sterile render lighting; no speed ramps; no whip pans; no repeated shots; no rotating captions; no oversized graphics; no distorted doors, drawers, hardware or cabinets; no spelling errors; no third-party phone numbers.
