...
def test_landscape_video_gets_portrait_blurred_fill(probe, run, tmp_path):
    probe.side_effect = [
        {"width": 1920, "height": 1080, "duration": 30.0, "audio_codec": "aac"},
        {"width": 1080, "height": 1920, "duration": 30.0, "audio_codec": "aac"},
    ]
    ...
    assert result["audio_handling"] == "copied_original_aac"
...
def test_portrait_video_is_still_normalized_to_exact_short_dimensions(probe, run, tmp_path):
    probe.side_effect = [
        {"width": 720, "height": 1280, "duration": 10.0, "audio_codec": "aac"},
        {"width": 1080, "height": 1920, "duration": 10.0, "audio_codec": "aac"},
    ]
...
def test_video_over_three_minutes_is_rejected(probe, tmp_path):
    probe.return_value = {"width": 1080, "height": 1920, "duration": 181.0, "audio_codec": "aac"}
